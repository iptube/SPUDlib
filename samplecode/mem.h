 ...
 * other function in either the jabberwerx library or the libevent2 library.
 * This is to ensure that all memory allocated with a particular malloc
 * implementation is freed wih the appropriately paired free implementation.
 *
 ...
 * \todo sinc this up with design durng 2010.15
 *
 ...
 * is freed during the given pool's destruction.
 *
 * This function can generate the following errors,
 * set when returning false:
 ...
 *                 size num*size. NULL if num*size == 0
 * \param[out] err The error information (provide NULL to ignore)
