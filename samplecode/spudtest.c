...
static const char* s1      =
  "[_]~~ c[_]~~ c[_]~~ COFFEE BREAK c[_]~~ c[_]~~ c[_]~~[_]~~ c[_]~~ c[_]~~ COFFEE BREAK c[_]~~ c[_]~~ c[_]~~[_]~~ c[_]~~ c[_]~~ COFFEE BREAK c[_]~~ c[_]~~ c[_]~~[_]~~ c[_]~~ c[_]~~ COFFEE BREAK c[_]~~ c[_]~~ c[_]~~";
        ...
        void*          arg)
{
  ...
  if (td->cbor)
  {
    ...
    if ( data &&
         ( (data->type == CN_CBOR_TEXT) || (data->type == CN_CBOR_BYTES) ) )
    {
